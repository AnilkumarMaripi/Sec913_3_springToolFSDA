...
public interface UsersRepository extends JpaRepository<Users, Long> {
	...
	@Query(value = "SELECT u.fullname as \"fullname\", u.email as \"email\", u.phone as \"phone\", r.rolename as \"rolename\" FROM users u JOIN roles r ON CAST(u.role AS BIGINT) = r.role", nativeQuery = true)
