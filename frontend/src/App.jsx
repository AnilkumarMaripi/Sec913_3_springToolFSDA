            ...
            <div className='container' key={isSignin ? "signin" : "signup"}>
                ...
                <div className='container-content'>
                    ...
                    :
                        ...
                        <div className='input-group'>
                            <img src={imgurl + "user.png"} />
                            <select name='role' value={signupData.role} onChange={(e)=>handleSignupInput(e)} className={errorData.role ? 'error' : ''}>
                ...
                <div className='container-footer'>Copyright @ 2026 Micro-Task Hub. All rights reserved.</div>
            </div>
